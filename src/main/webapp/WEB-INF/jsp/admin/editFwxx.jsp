	...
	<tr>
		...
		<td width="172" valign="top" align="center">
			...
			<table align="center">
				...
				<tr>
					<td width='150'><a href="listMyFwxx.html">管理我的租房信息</a></td>
				</tr>
				<tr>
					<td width='100'><a>发布租房信息</a></td>
				</tr>
				<tr>
					<td width='100'><a href="user/toListMyFwxx">返回首页</a></td>
				</tr>
				<tr>
		...
		<td width="495" align="center">
			<f:form action="houseInfo/edit" modelAttribute="houseInfo" method="post">
				<f:hidden path="houseId"/>
				<table>
					<tr>
